(function() {
    ...
    const firstNameHTML = document.getElementById('firstName-input');
    const lastNameHTML = document.getElementById('lastName-input');
    ...
    function checkFirstName() {
        ...
        if (firstName === ''){
            message.innerHTML = "<b> <span style='color:rgb(221, 25, 42);'> Morate uneti ime";
        }
        else{
            checkLastName();
        }
    ...
    function checkLastName() {
        ...
        if (lastName === ''){
            message.innerHTML = "<b> <span style='color:rgb(221, 25, 42);'> Morate uneti prezime"
        }
        else{
            parseJMBG();
        }
    ...
    function checkJMBG() {
        if (day < 1 || day > 31) {
            ...
            message.innerHTML = "<b> Neispravan mesec rođenja";
            ...
            message.innerHTML = "<b> Neispravno unet pol";
    ...
    function setPerson() {
        switch (region) {
            ...
            case 5:
                ...
                break;
            case 6:
                region = "Nedefinisano mesto rodjenja";
                break;
            case 7:
